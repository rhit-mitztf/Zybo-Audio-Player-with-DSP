...
// Number of samples to record/playback per one channel
#define NR_AUDIO_SAMPLES (NR_SEC_TO_REC_PLAY * AUDIO_SAMPLING_RATE)

// One channel sample contains this many bytes
#define BYTES_PER_SAMPLE 4

//number of bytes per second across both channels
#define BYTES_PER_SECOND (NR_CHANNELS * BYTES_PER_SAMPLE * AUDIO_SAMPLING_RATE)

#define RECORDING_SIZE_BYTES (NR_SEC_TO_REC_PLAY * BYTES_PER_SECOND)
#endif
